  ...
  return (
    ...
    >
      ...
      <div className="sm:flex max-h-[1000px] h-[100%] overflow-clip max-w-[1450px] md:px-[32px] px-5 mx-auto gap-5 justify-around">
        ...
        <div 
          className={`absolute mx-5  px-3 shadow-2xl rounded-b-lg rounded-tl-lg z-40 right-0 left-0 bg-slate-800 h-[91.2%] overflow-y-scroll sm:hidden transition-all duration-500 ease-in-out ${
